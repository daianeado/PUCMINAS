   ...
   abstract class Funcionario
    {
        ...
        //Estes quatro métodos são a lista de serviços da classe, também chamados, coletivamente, de interface da classe.
        ...
        abstract  public void ImprimeInformacoesEspecificas(); 
    }

    //Classe herdeira de Funcionario.
     // Todo gerente É UM funcionário com algo a mais. Neste caso, o "algo a mais" é o membro de dados bonus e os métodos de acesso a ele.
    class Gerente : Funcionario
    {
        private double bonus;

        // this, aqui, é utilizado para chamar outra construtora da classe Gerente.
        ...
        // new, neste contexto, indica que o método é uma redefinição de método homônimo (de mesmo nome) da classe Funcionario. 
        //base.getSalario() chama o método herdado de Funcionario, a classe base de Gerente.
        
        override public double getSalario() 
        { 
          Console.WriteLine("getsalario de Gerente!!!!"); 
        ...
        public override void ImprimeInformacoesEspecificas()
        {
    ...
    class Executivo : Gerente
    {
        ...
        public override void ImprimeInformacoesEspecificas()
        {
            Console.WriteLine("Idiomas: " + getIdiomas());
        }
    }
    ...
    class Tecnico : Funcionario
    {
        ...
        public override void ImprimeInformacoesEspecificas()
        {
            Console.WriteLine("Area de Atuação: " + getAreaAtuacao());
        }
    }
    ...
    class FolhaDePagamento
    {
        ...
        // Este método é privativo, pois ele só existe para implementar um método da interface da classe.
        ...
        public void imprime()
        {
            for (int i = 0; i < this.funcionarios.Length; i++)
            {
                ...
                this.funcionarios[i].ImprimeInformacoesEspecificas();
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Esta chamada é válida, pois o TIPO ESTÁTICO (tipo declarado) de f1 é Funcionario e o método getNome foi declarado em Funcionario.
            f1.getNome();

            // Chamar f1.setAreaAtuacao("Suporte") é um erro, pois o  TIPO DINÂMICO (tipo do objeto referenciado) de f1 é Tecnico,
